...
def test_univariate_gaussian():
    ...
    fig1.update_layout(title='distance between the estimated and true value of the expectation according to sample size')
    fig1.show()
...
def test_multivariate_gaussian():
    ...
    return round(max_f1, 3), round(max_f3, 3)
